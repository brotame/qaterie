...
export default class Pastry {
  ...
  storeElements() {
    ...
    this.pastryNumber = this.pastryBlock.querySelector(".tm-pastry_number");
    this.quantityLabel = this.pastryBlock.querySelector(".tm-quantity_label");
  ...
  getOptions(inputName = "init") {
    ...
    switch (inputName) {
      ...
      case "category":
        this.quantityLabel.textContent = selectedCategory.label;
